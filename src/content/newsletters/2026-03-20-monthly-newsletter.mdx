...
import img2026031 from '../../assets/images/newsletters/2026_03_1.png';
import img2026032 from '../../assets/images/newsletters/2026_03_2.jpg';
import img2026033 from '../../assets/images/newsletters/2026_03_3.png';
import img2026034 from '../../assets/images/newsletters/2026_03_4.jpg';
import img2026035 from '../../assets/images/newsletters/2026_03_5.jpg';

*TLDR: Check out [our latest blog posts & follow our Medium blog](https://medium.com/science-policy-in-a-snap), and [join Stance on Science](https://snapcoalition.org/initiatives/stance-on-science)! Need a job or fellowship? Look at our "External Opportunities" section.*

*Upcoming SNAP Event: "Change Minds and Stop the Spread of Misinformation" with Dr. Michael Czajkowski from Science for Georgia on Tuesday, March 24th at 7pm EST on Zoom! Register here: [https://forms.gle/4vvD3emT5dgiVMtb9](https://forms.gle/4vvD3emT5dgiVMtb9)*
...
<Figure src={img2026031} alt={'SCIENCE TALK \'26'} />
...
This week is a piece from SNAPpers Brendan Davis and Becca Blyn, recapping the wild saga of this past year's federal appropriations process regarding science funding, culminating in their take on who came out on top. Read their piece, **"The Appropriations Rollercoaster: Which Sciences Won and Lost"** [here](https://medium.com/science-policy-in-a-snap/the-appropriations-rollercoaster-which-sciences-won-and-lost-d222296eb7ec)!
...
Finally, in case you missed our plenary panel, you can watch a recording [here](https://www.youtube.com/watch?v=QuLj_1V2KeY&list=PLb3g2qjmLDjOTMZGnch6JsVMFULEfptSF&index=2).

<Figure src={img2026032} alt={'AAAS 2026'} />

#### External Opportunities
- [Missouri Science & Technology Legislative (MOST) Policy Fellowship](https://mostpolicyinitiative.org/fellows/apply/) - Applications due April 1
- Other state sci pol fellowships:
  - [COPA-STEP (PA legislative)](https://lpe.psu.edu/career-development/fellowships-traineeships/pennsylvania-legislative-science-technology-policy-fellowship)
  - [PA Governor's](https://www.linkedin.com/posts/thomaspfoley_stemcareers-publicservice-pennsylvaniajobs-activity-7439428811412340736-rYgR)
    - \* [Link to both PA fellowships' information session (3/30)](https://www.linkedin.com/posts/stefan-t-peterson-phd-103724159_sciencepolicy-scienceforpolicy-stemfellowship-activity-7440784114858819585-4f-A)
  - [Idaho](https://www.linkedin.com/posts/istpf_science-engineering-socialscience-activity-7435475392938983424-tAGL)
  - [West Virginia](https://www.linkedin.com/posts/wvstep_hiring-ugcPost-7434293321809797121-e1_c)
  - [New Jersey Eagleton](https://www.linkedin.com/posts/eagleton-science-and-politics-program_scienceforthecommongood-science-policy-activity-7438188371841290240-LkD4)
- [Climate Science Serving America Fellowship](https://drawdown.org/careers/climate-science-serving-america-fellowship) - Applications due April 17
- Are you a woman or nonbinary person of color (POC) interested in a career in science policy or science communication? Please sign up for [this Guerrilla Mentoring event](http://tinyurl.com/vs-mentees) from the creators of [VanguardSTEM](https://www.linkedin.com/company/vanguardstem/)!
- Paid 12-month internship: [Communications Officer](https://biologists.com/wp-content/uploads/Internship.pdf). An exciting opportunity for someone looking to take their first step into a science communication or publishing role. Based in Cambridge, UK (& WFH).
- The Institute of Advanced Study is recruiting a [Civic Science Fellow](https://jobs.chronicle.com/job/37962820/civic-science-fellow-school-of-social-science-18-month-appointment/)!
- Applications for the [Google Public Policy Fellowship](https://www.google.com/policyfellowship/usa/) are open! If you are a student interested in Internet & tech policy, apply today.
- The [Policy Fellow at Policy@MIT](https://careers.peopleclick.com/careerscp/client_mit/external/jobDetails/jobDetail.html?jobPostId=33661&localeCode=en-us) will coordinate efforts to elevate and strategically shape policy-relevant research across MIT, identifying new opportunities aligned with policymaker needs.
...
- SNAPpers and co-originators of the McClintock Letters initiative Emma Scales and Izzi Di Tomassi received the [Meeting the Moment for Public Health Award](https://www.researchamerica.org/advocacy-awards/the-mcclintock-letters/) on behalf of SNAP, the Cornell Advancing Science and Policy Club, and all those who participated in the McClintock Letters at the Research!America Advocacy Awards in D.C. on March 10th! Di Tomassi also [participated in a panel](https://youtu.be/oXjJPv0ltxM?si=3Nle-yAwrAzPsPbE) addressing how public engagement and dialogue builds trust.

<Figure src={img2026033} alt={'McClintock Letters award'} />
...
- JP Flores published an op-ed in [The Hechinger Report](https://hechingerreport.org/opinion-pathways-for-future-scientists-are-becoming-scarce-threatening-a-strong-and-innovative-workforce/) about expanding undergraduate research opportunities to HBCUs, regional public universities, and community colleges.
- JP Flores published an op-ed in [Science Politics](https://sciencepolitics.org/2026/03/18/were-training-scientists-for-a-world-that-no-longer-exists/) about how we're training scientists for a world that no longer exists.
...
<Figure src={img2026034} alt={'UMD Advocacy Week'} />
