...
import img202512ScienceDiplomacyGrid from '../../assets/images/newsletters/2025_12_science_diplomacy_grid.jpg';

*TLDR: [Sign-up](https://docs.google.com/forms/d/e/1FAIpQLSem6bVuZnK7eWls-CTMpxWxaxHpuElNj4oOXIvLkgDYRO6YNg/viewform) for Stance on Science to see where midterm candidates stand on science policy issues. And be on the look out for SNAP in 2026! Next year, you will be able to find us at the AAAS meeting, join our upcoming SciPol Hackathon, or learn more about science policy from our SciPol course modules.*

#### AAAS 2026
At the AAAS Meeting this February, five SNAP members (Miles Arnett, Isako Di Tomassi, JP Flores, Erin Morrow, and Alex Rich) are speaking on a [plenary panel](https://meetings.aaas.org/program/lectures/) discussing the work SNAP has done and is continuing to do. Several members are also presenting their work in the E-poster session, and SNAP is hosting a booth where you can meet members in person to get connected with our initiatives. Stay tuned for a full list of the events we’ll be participating in!
...
#### McClintock Letters
[This initiative](https://snapcoalition.org/initiatives/mcclintock-letters/) is a nationwide science communication project in which hundreds of scientists wrote to their local hometown papers to convey the value of federally funded research to a diverse audience. We have had over 200 pieces published across at least 44 states!

Did you write a letter? Thanks to a new partnership between The McClintock Letters and [SciTech Forefront](https://medium.com/scitech-forefront), you can now (re)publish your letters on the Forefront platform to increase their visibility, accessibility, and impact. We understand the publication process was difficult for many, so here's a chance to get your letter out there if you haven't already, or to publish it again! Email us for more information. 

#### SNAP Visits
As we evaluate the impacts of the [Congressional District Visits](https://snapcoalition.org/initiatives/district-visits/), one thing is clear: scientists show up for their science! Through this initiative, early-career scientists across 29 states met with over 55 Congressional offices this August and September, sharing stories about their science and the value of research.

- Are you one of the scientists who participated? Don't forget to fill out the reflection survey found [here](https://forms.gle/wAsQYFHXQhjGX1FV6)!
...
- [Research!America Civic Engagement Microgrant Program](https://www.researchamerica.org/civic-science/microgrants/?sm_guid=OTA1NzA2fDgyMjEzNjM3fC0xfGEucmljaEB5YWxlLmVkdXw4MzAzODUyfHwwfDB8Mjg3NjMxNTU3fDk1M3wwfDB8fDkwMjIxNnww0) Due 01/01/2026
- [Science for Public Good Fund](https://secure.ucs.org/a/2025-science-public-good-fund-apply-today) Due 01/06/2026
- [Society for Neuroscience Early Career Policy Ambassador Program](https://www.sfn.org/advocacy/us-advocacy-programs/early-career-policy-ambassadors) Due 01/07/2026
- [AIBS/SURA Public Policy Fellowship](https://www.aibs.org/news/2025/251203-policy-fellow#subheader) Due 01/28/2026
- [AIBS Congressional Visits Day](https://www.aibs.org/news/2025/251215-congressional-visits-day#subheader) Registration due 02/23/2026
...
- A team of SNAPers (Emily Selland, Sneha Rao, Emma Scales, David Ramotowski, and Alex Lando) was accepted to give a panel at [SCIENCE TALK '26](https://www.associationofsciencecommunicators.org/conferences/science-talk-26/) hosted by the Association of Science Communicators.
- Amanda Finn and SNAP's Congressional District Visits were featured in a new article in *Forbes*, "[Students Advocate For More Science Funding](https://www.forbes.com/sites/johndrake/2025/12/03/students-advocate-for-more-science-funding/)".
...
<Figure src={img202512ScienceDiplomacyGrid} alt={'Group photo at Science Diplomacy Grid holiday event'} />
